...
public class CommonConstant {
    ...
    public static final String ROOT_CONTEXT="/api";
    ...
    public static final String SYSTEM_USER_EMAIL="email";
    public static final String SYSTEM_USER_PHONE_NUMBER="phone_number";
}
