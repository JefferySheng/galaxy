...
import com.galaxy.framework.base.pagination.PageableCriteria;
...
public class BaseServiceImpl<T> implements BaseService<T> {
    ...
    public T selectOne(Criteria<T> criteria){
        return this.selectOne(new EntityWrapper<T>(),criteria,null);
    }
    @Override
    ...
    public Map<String, Object> selectMap(Criteria<T> criteria){
        return this.selectMap(new EntityWrapper<T>(),criteria,null);
    }
    ...
    public Object selectObj(Criteria<T> criteria){
        return this.selectObj(new EntityWrapper<T>(),criteria,null);
    }
    ...
    public int selectCount(Criteria<T> criteria){
        return this.selectCount(new EntityWrapper<T>(),criteria,null);
    }
    ...
    public List<Object> selectObjs(Criteria<T> criteria){
        return this.selectObjs(new EntityWrapper<T>(),criteria,null);
    }
    ...
    public List<T> selectList(Criteria<T> criteria){
        return this.selectList(new EntityWrapper<T>(),criteria,null);
    }
    ...
    public Page<T> selectPage(Page<T> page, Criteria<T> criteria){
        return this.selectPage(page,new EntityWrapper<T>(),criteria,null);
    }
